...
mpl.style.use('fivethirtyeight') # optional: for fivethirtyeight like style
...
# using df_continents dataset created earlier
# autopct create %, start angle represent starting point
colors_list = ['rosybrown', 'olive', 'burlywood', 'indigo', 'plum', 'crimson']
explode_list = [0.1, 0, 0, 0, 0.1, 0.1] # ratio for each continent with which to offset each wedge.
...
# Subplot 1: Box plot
df_CI.plot(kind='box', color='orangered', vert=False, figsize=(20, 6), ax=ax0) # add to subplot 1
...
plt.title('Box plot of Top 15 countries in from 80s to 2000s')
plt.ylabel('Number of Immigrants')
...
```
    ...
    <matplotlib.legend.Legend at 0x7fcf24350a20>
...
ax0 = df_can_t.plot(kind='scatter',
                    ...
                    alpha=0.5,                  # transparency
                    color='indianred',
                    s=norm_india * 2500 + 10,  # pass in weights 
                    xlim=(1975, 2015)
                   )
...
```
    ...
    <matplotlib.legend.Legend at 0x7fcf243a56a0>
