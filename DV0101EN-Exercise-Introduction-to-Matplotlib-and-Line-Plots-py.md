...
```
    ...
    <matplotlib.axes._subplots.AxesSubplot at 0x7f8ea38a5588>
...
df2 = df_can.loc[['China','India'], years] # passing in years 1980 - 2013 to exclude the 'total' column
df2.head()
```
...
```
    ...
    <matplotlib.axes._subplots.AxesSubplot at 0x7f8e9af250f0>
...
f_top5.index = df_top5.index.map(int) # change the index values of df_top5 to type integer for plotting
...
```
    ...
    <ipython-input-85-9e75f660ba7a> in <module>()
          1 ### type your answer here
    ----> 2 df_can = df_can.sort_values(by='Total',ascending=False, axis=0,inplace=True)
          3 df_top5 = df_can.head(5)
          4 df_top5 = df_top5[years].transpose()
          5 print(df_top5)
